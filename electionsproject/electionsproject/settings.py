...
## environment setting
mccelectionsenv = "local"

## Results API base url
MCC_API_BASE_URL = "127.0.0.1:8000/api"
...
SECRET_KEY = '#r6y=n_5(^h^*6v3r7q=l@r7o33xt*&tooj)aeggw-r)tw(-$w'

# SECURITY WARNING: don't run with debug turned on in production!
# debug_setting = os.environ['DEBUG_SETTING_MCCELECTIONS']
# DEBUG = debug_setting
# mccelectionsenv = os.environ['MCCELECTIONSENV']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'django.template.loaders.app_directories.Loader', ## added based on docs for django-slack
            ],
        },
    },
]
